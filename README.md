...
Repository Structure priority_roundrobin.py sequential_allocation.py indexed_allocation.py memory_fit.py mft_mvt.py README.md sample_outputs/ # optional screenshots/output logs

Learning Objectives

Understand CPU scheduling behavior Simulate file allocation strategies Analyze memory allocation performance Apply OS theory in Python programs
